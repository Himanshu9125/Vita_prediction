...
Original file is located at
    https://colab.research.google.com/drive/1PZSM7HEjBUK3RbYBxSgeEx8vrGJLHAud
...
new_data = pd.DataFrame([[5, 20]], columns=['Cataegory','Total'])
Gender_prediction = knn.predict(new_data)
